...
export class SourceSpan {
  ...
  constructor(public readonly text: string, public readonly span: Span) {
    // pass
  }
  ...
  get startLine(): Line {
    ...
    this._startLine = calculateLine(this.text, this.span.start);
    return this._startLine;
  }

  get endLine(): Line {
    if (this._endLine) return this._endLine;
    this._endLine = calculateLine(this.text, this.span.end);
